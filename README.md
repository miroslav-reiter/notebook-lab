# 🤖 Online Kurz Google Gemini Notebook (NotebookLM)
...
> Google Gemini Notebook (NotebookLM) nepoužívame iba na sumarizovanie. Používame ho na riadenú analýzu zdrojov, porovnávanie tvrdení a tvorbu výstupov, ktoré vieme spätne overiť.
